...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname before) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define yellow (square 10 "solid" "yellow"))
(define blue (square 10 "solid" "blue"))

(above (beside blue yellow)
       (beside yellow blue))